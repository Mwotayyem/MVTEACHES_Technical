...
| Area | Status |
|---|---|
| Razor UI (most pages) | **Just started.** Login and one Dashboard screen exist (see above) — Student Register, Student Profile, Payment History, Payroll review, Certificate approval list, and everything else in §14 still does not. Almost certainly the largest remaining item. |
