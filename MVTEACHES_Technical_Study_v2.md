...
هل يجوز للطالب إعادة مقابلة تحديد المستوى؟ كم مرة؟ بفاصل زمني؟ بمقابل مادي؟ — النموذج يدعم محاولات متعددة (`placement_attempts`)، **لكن السياسة غير محددة**. انظر `Q-11`.
