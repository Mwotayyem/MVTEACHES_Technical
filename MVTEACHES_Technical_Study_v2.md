...
|---|---|
| **الإصدار** | **v2.1** |
| **تاريخ الإصدار** | 2026-08-17 · **مُحدَّثة 2026-08-19** |
| **يحل محل** | `MVTEACHES_Technical_Study_v1.md` (v1.0) |
| **الحالة** | Pre-Development — Implementation Blueprint |
| **الأساس الجديد** | «OFFICIAL BUSINESS DECISIONS» (2026-08-17) + **10 قرارات إضافية من المالك (2026-08-19)** — D-38…D-47 |
...
| **D-42** | **غياب الطالب** | **بعذر مقبول → تعويض بقرار الأدمن** · **بلا عذر → يُستهلك ويضيع** | 🔴 **يحل `Q-02`** — قيم `reason` في الدفتر محسومة |
...
| هل نموذج العمل متسق داخليًا الآن؟ | ✅ **متسق.** قرار **«لا تقسيط» (D-38)** حلّ `CONF-01`، و**سياسة الغياب (D-42)** حلّت `Q-02`. بقي `CONF-04` (تعارض تواريخ) و`CONF-05` مغلقًا جزئيًا. |
...
### ✅ `Q-02` — سياسة الغياب بمبادرة الطالب — **حُسم (D-42)**
...
> |---|---|---|
> | **عذر مقبول** (بإخطار مسبق) | ❌ لا يُستهلك | ✅ **بقرار الأدمن** — صلاحية 30 يومًا (D-19) |
...
| ✅ `Q-09` | **الحصص الخاصة** — **مؤكدة (D-27)** | أجر المعلم = **سعر ساعته × عدد الساعات** · ⚠️ **بقي سؤال واحد:** هل يشتريها الطالب كمنتج في MVP أم هي ترتيب خارج المنصة؟ · ⚖️ «طفل ومعلم منفردان» يحتاج موافقة ولي أمر وسياسة سلوك |
